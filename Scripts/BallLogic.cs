...
{
	// --- Physics Constants ---
	[Export] public float Gravity = 800.0f;        // Increased to fall faster
	[Export] public float BounceElasticity = 0.8f; // Good bounce height
	[Export] public float AirDrag = 0.96f;         
	[Export] public float MaxSpeed = 700.0f;        
	...
	public override void _PhysicsProcess(double delta)
	{
		...
		// Apply Air Drag
		Velocity *= AirDrag;
		if (VerticalVelocity < 0) // If the ball is going UP
