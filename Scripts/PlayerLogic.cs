...
public partial class PlayerLogic : CharacterBody2D
{
	...
	[Export] public float ReachX = 60.0f;
	[Export] public float ReachY = 35.0f;
	[Export] public float MaxHitHeight = 65.0f; 
	...
	[Export] public bool ShowReachDebug = true;
   ...
   private void ExecuteHit(BallLogic ball, float diffX)
{
	...
	float horizontalPower = Mathf.Clamp(diffX * -2.5f, -200f, 200f);
	...
	ball.VerticalVelocity = -150.0f; // Constant upward pop
}
}
